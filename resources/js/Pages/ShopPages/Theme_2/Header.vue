      ...
      <div class="header-bottom wow animate__fadeInDown" data-wow-duration="1s">
        <div class="container">
          ...
          <div class="__right">
            ...
            </ul><a class="menu-shopping-cart" href=""><i class="fas fa-shopping-basket"></i>
          ...
          </div><a class="open-mobile-menu" href="javascript:void(0)"><span class="text-uppercase">menu</span><i class="fas fa-bars"></i></a>
        </div>
      </div>
    </header>
