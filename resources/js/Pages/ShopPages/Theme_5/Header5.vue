    ...
    <header class="header-v5">
      ...
      <div class="header-bottom wow animate__fadeInDown" data-wow-duration="1s">
        <div class="container">
          ...
          <div class="restaurant-status open wow animate__bounceInDown" data-wow-duration="1s"><img class="img-fluid" src="/assets/img/icon/open.svg"/><img class="img-fluid" src="/assets/img/icon/closed.svg"/></div>
          <ul class="menu">
