<template>
   <header class="header-v3">
      ...
      <div class="header-bottom wow animate__fadeInDown" data-wow-duration="1s">
        <div class="container"><a class="logo" href="#slide"><img class="img-fluid" :src="'/image/'+logo"/></a>
          <ul class="menu">
          ...
          <div :class="'restaurant-status '+(timeSetting.open?'open':'closed')+' wow animate__bounceInDown'" data-wow-duration="1s"><img class="img-fluid" src="/img/icon/open.svg"/><img class="img-fluid" src="/img/icon/closed.svg"/></div><a class="open-mobile-menu" href="javascript:void(0)"><span class="text-uppercase">menu</span><i class="fas fa-bars"></i></a>
        </div>
      </div>
    </header>
