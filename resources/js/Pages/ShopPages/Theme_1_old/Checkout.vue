                ...
                <div class="box list_category_style_1">
                  ...
                  >
                    <ul class="box-category">
                      ...
                      <li>
                        <a
                          href="https://www.stationkebabs.co.uk/menu#kebabs"
                          class="cat-active"
                          data-name="KEBABS"
                          data-href="#kebabs"
                          data-id="1739"
                      ...
                      <li>
                        <a
                          href="https://www.stationkebabs.co.uk/menu#wraps"
                          class="cat-active"
                          data-name="WRAPS"
                          data-href="#wraps"
                          data-id="1740"
                      ...
                      <li>
                        <a
                          href="https://www.stationkebabs.co.uk/menu#meal-deals"
                          class="cat-active"
                          data-name="MEAL DEALS"
                          data-href="#meal-deals"
                          data-id="1918"
                          >MEAL DEALS (6)</a
                        >
                      </li>
                      <li>
                        <a
                          href="https://www.stationkebabs.co.uk/menu#burgers"
                          class="cat-active"
                          data-name="BURGERS"
                          data-href="#burgers"
                          data-id="1741"
                      ...
                      <li>
                        <a
                          href="https://www.stationkebabs.co.uk/menu#jacket-potatoes"
                          class="cat-active"
                          data-name="JACKET POTATOES"
                          data-href="#jacket-potatoes"
                          data-id="1743"
                          >JACKET POTATOES (5)</a
                        >
                      </li>
                      <li>
                        <a
                          href="https://www.stationkebabs.co.uk/menu#starters"
                          class="cat-active"
                          data-name="STARTERS"
                          data-href="#starters"
                          data-id="1744"
                      ...
                      <li>
                        <a
                          href="https://www.stationkebabs.co.uk/menu#extras"
                          class="cat-active"
                          data-name="EXTRAS"
                          data-href="#extras"
                          data-id="1745"
                      ...
                      <li>
                        <a
                          href="https://www.stationkebabs.co.uk/menu#desserts"
                          class="cat-active"
                          data-name="DESSERTS"
                          data-href="#desserts"
                          data-id="1746"
                      ...
                      <li>
                        <a
                          href="https://www.stationkebabs.co.uk/menu#pizza-deals"
                          class="cat-active"
                          data-name="PIZZA DEALS"
                          data-href="#pizza-deals"
                          data-id="1747"
                          >PIZZA DEALS (8)</a
                        >
                      </li>
                      <li>
                        <a
                          href="https://www.stationkebabs.co.uk/menu#kids-meal"
                          class="cat-active"
                          data-name="KIDS MEAL"
                          data-href="#kids-meal"
                          data-id="1749"
                      ...
                      <li>
                        <a
                          href="https://www.stationkebabs.co.uk/menu#sauces"
                          class="cat-active"
                          data-name="SAUCES"
                          data-href="#sauces"
                          data-id="1748"
                      ...
                      <li>
                        <a
                          href="https://www.stationkebabs.co.uk/menu#drinks"
                          class="cat-active"
                          data-name="DRINKS"
                          data-href="#drinks"
                          data-id="1919"
                  ...
                  <div class="responsive_cart">
                    <div id="cart" class="ybccart">
                      ...
                      <div class="content">
                          ...
                          <table>
                            <tbody>
                              <tr>
                                ...
                                <td class="remove">
                                  <img
                                    src="catalog/view/theme/default/image/remove-small.png"
                                    alt="Remove"
                                    title="Remove"
                                    onclick="removeCart('13878:YToxOntzOjc6InRvcHBpbmciO2E6MTp7czo0OiJiYXNlIjthOjA6e319fQ==::YTo0OntzOjY6ImlkX2NhdCI7czo0OiIxNzM5IjtzOjc6InJlcXVlc3QiO3M6MDoiIjtzOjk6InNpemVfYmFzZSI7czo0OiIxMzgxIjtzOjg6InRvcHBpbmdzIjthOjM6e2k6MTEyNDthOjE6e2k6MDtzOjU6IjExMjE2Ijt9aToxMTI1O2E6MTp7aTowO3M6NToiMTEyMTkiO31pOjExMjY7YToxOntpOjA7czo1OiIxMTIyOSI7fX19');"
                                  />
                                </td>
                              </tr>
                            </tbody>
                        ...
                        <div class="mini-cart-total">
                          <table>
                            <tbody>
                              ...
                              <tr>
                                <td class="right"><b>Total to pay:</b></td>
                                <td class="right">£9.50</td>
                              </tr>
                            </tbody>
                          </table>
                        ...
                        <div class="checkout">
                          <a
                            href="http://www.stationkebabs.co.uk/index.php?route=checkout/cart&amp;prams=collection"
                            class="checkbut"
                            >View Cart</a
                          >&nbsp;
                          <a
                            href="https://www.stationkebabs.co.uk/index.php?route=stepcheckout/checkout"
                            class="redbutton minimum_ets"
                            >Checkout</a
                          >
                        </div>
                      </div>
...
-->
                <div class="checkout">
                  <div v-if="step == 1" id="checkout" class="step_1">
                    <div class="checkout-heading">Checkout - step 1/3</div>
                    <div class="checkout-content">
                      <h2
                        data-toggle="tab-login"
                        data-disable="no"
                      ...
                      <transition name="slide">
                        ...
                        >
                          <a class="btnloginwithfacebook" href="#">
                            <i
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <div
                                      class="
                                        ybc_custom_form_group
                                        ybc_custom_form_firstname
                                      "
                                    >
                                      <input
                          ...
                          >
                            <div style="display: none">
                              ...
                              <label for="newsletter"
                                >I wish to subscribe to the STATION KEBABS
                                CLACTON-ON-SEA newsletter.</label
                              >
                              <br />
                            </div>
                            <br />
                  ...
                  <div v-if="step == 2" id="payment-address" class="step_2">
                    <div class="checkout-heading">
                      Checkout - step 2/3
                      <a>Modify »</a>
                    </div>
                    <div class="checkout-content">
                      <table class="form 1" id="customer" style="display: none">
                        <tbody>
                          <tr>
                            <td>
                              <select name="gender">
                      ...
                      <div class="partcheckout">
                        ...
                        <div id="order_type_top" class="contentpart">
                          <label @click="collectStatus"
                            ><input
                              ...
                              value="2"
                              name="setdelivery"
                            /><span>I will collect my order</span></label
                          >
                          <label @click="deliveryStatus"
                            ><input
                              class="input-collection"
                              type="radio"
                              value="1"
                              name="setdelivery"
                            /><span>Deliver to my address</span></label
                          >
                      ...
                      <div v-if="delivery" class="box-delivery-address">
                        <div class="title-heading">
                          <span>Delivery address</span>
                        </div>
                        <div class="add_0 form_add">
                          <input
                            type="hidden"
              ...
              <td style="display: none"></td>
                              ...
                              <tr style="display: none">
                                ...
                                <td>
                                  <select name="zone_id" class="large-field">
                                    <option selected="selected" value="3513">
                                      Aberdeen
                                    </option>
                                  </select>
                                </td>
                      ...
                      >
                        <div class="content">
                          ...
                          <!--  <div id="postcode_btn" ><a href="javascript:void(0)" id="col" onclick="changemenucard();" >COLLECTION</a><a href="javascript:void(0)" id="sub" onclick="getDeliveryArea()" >DELIVERY</a></div> -->
                        </div>
                      </div>

                      <div
                        id="order_type_warning"
                        style="display: none"
                        title="Warning"
                      >
                        <div class="content">
                  ...
                  <div v-if="step == 3" id="payment-method" class="step_3">
                    <div class="checkout-heading">Checkout - step 3/3</div>
                    <div class="checkout-content">
                      <div id="cartdetail">
                        <div id="wrapper">
                          <div id="content">
                            <div class="wrapper">
                              <div>
                                <ul>
                                  <li>
                                    <label class="title-heading"
                                      >My Basket
                                      <span class="st-arrow"></span>
                                    </label>
                                    <div
                                      class="st-content my-baskets"
                                      style="display: block; clear: left"
                                    >
                                      <!--form style="float:left;width:100%;" action="https://www.123.the-public.co.uk/index.php?route=stepcheckout/cart" method="post" enctype="multipart/form-data"-->
                                      <div class="cart-info">
                                        <div class="box-list-prod">
                                          <div class="quantity">
                                            <input
                                              ...
                                              min="1"
                                              max="999"
                                              name="quantity[2360:YToxOntzOjc6InRvcHBpbmciO2E6MTp7czo0OiJiYXNlIjthOjA6e319fQ==::YTo0OntzOjY6ImlkX2NhdCI7czowOiIiO3M6NzoicmVxdWVzdCI7czowOiIiO3M6OToic2l6ZV9iYXNlIjtzOjA6IiI7czo4OiJ0b3BwaW5ncyI7YTowOnt9fQ==]"
                                              data-key="0"
                                              value="1"
                                              size="1"
                                            />
                                          ...
                                          <div class="name">
                                            <a
                                              href="http://www.123.the-public.co.uk/menu"
                                              style=""
                                            >
                                              Reshmi Kebab Starter</a
                                            ><br />
                                            <div
                                              class="topping"
                                            ></div>
                                            <div
                                              class="show-custom-field"
                                            ></div>
                                          </div>
                                          <div class="total">£2.90</div>
                                          <div class="action">
                                            <a
                                              class="remove_product"
                                              data-key="0"
                                              href="http://www.123.the-public.co.uk/index.php?route=checkout/cart&amp;remove=2360:YToxOntzOjc6InRvcHBpbmciO2E6MTp7czo0OiJiYXNlIjthOjA6e319fQ==::YTo0OntzOjY6ImlkX2NhdCI7czowOiIiO3M6NzoicmVxdWVzdCI7czowOiIiO3M6OToic2l6ZV9iYXNlIjtzOjA6IiI7czo4OiJ0b3BwaW5ncyI7YTowOnt9fQ=="
                                            >
                                            ...
                                            &nbsp;
                                            <!--<input id="ybc_timing" class="" type="image" src="catalog/view/theme/default/image/update.png" alt="Update" title="Update" /> -->
                                            <!--<img id="ybc_timing" class="update_0" src="catalog/view/theme/default/image/update.png" alt="Update" title="Update" /> -->
                                            <span
                                              id="ybc_timing"
                                              class="update_0"
                                            >
                                    ...
                                    <li>
                                      ...
                                      <div class="st-content">
                                        <div id="voucher" class="content">
                                          <form
                                            action="https://www.123.the-public.co.uk/index.php?route=stepcheckout/cart"
                                            method="post"
                                            enctype="multipart/form-data"
                                          >
                                            <div style="display: none">
                                              Enter your gift voucher code
                                              here:&nbsp;
                                            </div>
                                            <div
                                              class="
                                                ybc_custom_form_group
                                                ybc_custom_form_group_after
                                                fa fa-caret-up
                                              "
                                            >
                                              <input
                            ...
                            <div class="custom_payment_method_ets">
                              <div
                                id="payment_method_ets"
                                class="checkout_select sang"
                              >
                                <div
                                  class="
                                    payment-class
                                ...
                                >
                                  <input
                                    type="radio"
                                    name="payment_method"
                                    value="myfoodbasketpayments_gateway"
                                    id="myfoodbasketpayments_gateway"
                                  /><span class="check_btn"></span
                                  ><img
                                    src="/image/payment_logos/checkout-payment-card.png"
                                  />
                                </div>

                                <div class="payment-class cod">
                                  <input
                                    type="radio"
                                    name="payment_method"
                                    value="cod"
                                    id="cod"
                                  /><span class="check_btn"></span
                                  ><img src="/image/payment_logos/cash.png" />

                                  <label class="ybc_cod" for="cod"
                                    >Cash on Collection
                                  </label>
                                </div>
                              </div>
                            ...
                            <div
                              ...
                              style="display: none"
                            >
                              <div class="billingaddress-laabel">
                                <label style="font-size: 18px"
                                  >Billing Address:</label
                                ><br />
                                <label
                                  >This is the address associated with your
                                  credit card.</label
                                ><br />
                                <input
                                  id="ets_shipping_address"
                                  type="checkbox"
                                  value="1"
                                  name="shipping_address"
                                />
                                <label
                                  >If it is same delivery address please tick
                                  here:</label
                                ><br />
                              </div>

                              <div
                                id="ets_billing_address"
                                class="form-group billing-address"
                              >
                                <div class="ybc_custom_form_group fa fa-user">
                                  <input
                                    type="text"
                                    name="company"
                                ...
                                <div
                                  class="ybc_custom_form_group fa fa-map-marker"
                                >
                                  <input
                                    type="text"
                                    name="address_1"
                                ...
                                <div class="ybc_custom_form_group small-city">
                                  <input
                                    type="text"
                                    name="city"
                                    placeholder="City"
                          ...
                          <div class="buttons box-action">
                            ...
                            <div style="display: none" id="ybcnotification">
                              <div class="ybcnoti" style="font-size: 10px">
                                Please Wait! we are confirming the payment.
                              </div>
                  ...
                  <div v-if="step == 4" id="confirm" class="step_4">
