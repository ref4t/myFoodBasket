<template>
    <header class="header-v4">
      ...
      <div class="header-bottom wow animate__fadeInDown" data-wow-duration="1s">
        <div class="container"><a class="logo" href="#"><img class="img-fluid" :src="'/image/'+logo"/></a>
          <ul class="menu">
          ...
          <div class="__btn-group"><a class="btn __purple text-capitalize" href="#"><i class="fas fa-shopping-cart"></i>my cart</a><a class="btn __green text-capitalize" href="#">login or signup</a></div><a class="open-mobile-menu" href="javascript:void(0)"><span class="text-uppercase">menu</span><i class="fas fa-bars"></i></a>
        </div>
      </div>
    </header>
    <div class="mobile-menu-shadow"></div>
    <sidebar class="mobile-menu"><a class="close far fa-times-circle" href="#"></a><a class="logo" href="#slide"><img class="img-fluid" :src="'/image/'+logo"/></a>
      <div class="top">
        <ul class="menu">
         <li :class="route().current('shopHome') ? 'active' : ' ' "><Link class="text-uppercase" href="/">home</Link></li>
          <li :class="route().current('shopMember') ? 'active' : ' ' "><Link class="text-uppercase" href="/member">member</Link></li>
